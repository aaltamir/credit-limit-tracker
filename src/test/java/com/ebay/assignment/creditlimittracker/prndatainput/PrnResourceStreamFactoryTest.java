...
class PrnResourceStreamFactoryTest {

    private PrnResourceStreamFactory factory;

    @BeforeEach
    void setUp() throws UnsupportedEncodingException {
        factory = new PrnResourceStreamFactory(new ByteArrayResource("Test data".getBytes(StandardCharsets.UTF_8.name())));
    }
    ...
    @Test
    void getSourceTest() {
        Assertions.assertEquals("prn-file", factory.getSource());
    }
}